...
This is an image for [Jenkins](https://jenkins.io) agent (FKA "slave") using JNLP to establish connection optimised for CentOS builds and preconfigured jenkins folder.
